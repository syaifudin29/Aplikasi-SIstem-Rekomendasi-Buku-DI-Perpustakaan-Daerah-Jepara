        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" method="POST" action="<?php echo base_url('login/prosesdaftar'); ?>">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Nama Lengkap" aria-label="nama_lengkap" name="nama" aria-describedby="basic-addon1" required>
                                </div>
                                <!-- email -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" name="user" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3 d-grid">
                                     ...
                                     <div class="pt-3 d-grid">
                                        <a  href="<?php echo base_url('/'); ?>" class="btn btn-block btn-lg btn-light" type="submit">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
